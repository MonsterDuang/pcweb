                                    ...
                                    <div class="img-preivew">
                                        ...
                                        <div class="clearfix">
                                            <div class="img-box" v-for="(item,index) in previewImg" :key="index">
                                                <img :src="item" alt="">
                                                <span @click="removeImg(item)" class="remove-img el-icon-circle-close-outline"></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        methods: {
            ...
            upload() {
                ...
                if (!/^\d+(\.{0,1}\d+){0,1}$/.test(this.auction.postage)) {
                    this.$message.error('请输入邮费邮费是必须的且邮费不能是负数')
                    return
                }
                ...
                this.loading = true;
                this.imgReady = true;
                if (this.auction.photoKeys.length >= 1) {
                    this.confrim()
                } else {
            ...
            confrim() {
                ...
                addAuction(this.auction).then((res) => {
                    this.loading = false;
