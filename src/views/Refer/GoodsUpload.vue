...
<template>
    <div class="refer-goods-view">
        ...
        <div class="goods-content" id="container" v-loading="loading">
            <div class="container">
                <div class="goods-box">
                    <h4 class="goods-head">上传商品</h4>
                    <div class="goods-info">
                        <ul class="info-box">
                            <li class="info-line clearfix">
                                <span class="info-name">商品名称:</span>
                                <div class="info-val">
                                    <input v-model="goods.name" type="text" placeholder="请输入商品名称">
                                </div>
                            </li>
                            <li class="info-line clearfix">
...
export default {
  ...
  methods: {
    ...
    uploadImg() {
      if (!this.goods.name) {
        this.$message.error("商品名称是必须的");
        return;
      }
      if (!this.goods.price || this.goods.price <= 0) {
      ...
      if (this.uploadFiles.length < 3 || this.uploadFiles.length > 6) {
        this.$message.error("请选择至少3张至多6图片");
        return;
      }
      ...
      if (typeof this.goods.postage !== "number") {
        this.$message.error("邮费必须是数字");
        return;
      }
      if (
