...
<template>
    <div class="order-view" v-loading="loading">
        <router-link class="setting-url" :to="{name: 'shopSetting'}">店铺设置</router-link>
        <a class="statis-url" @click="getStatisticsData">{{showStatis?'订单管理':'统计'}}</a>
        <el-tabs v-show="!showStatis" class="order-tab" v-model="currTab" @tab-click="handleClick">
            <el-tab-pane name="nopay">
                ...
                <div class="tab-view-container">
                    ...
                    <personl-center-order-item v-for="item in orderList['nopay']" :key="item.id" :order="item" @receiving="receiving" @redfunding:agree="agree" @redfunding:refuse="refuse"></personl-center-order-item>
            ...
            <el-tab-pane name="wait-shipping">
                ...
                <div class="tab-view-container">
                    ...
                    <personl-center-order-item v-for="item in orderList['wait-shipping']" :key="item.id" :order="item" @receiving="receiving"></personl-center-order-item>
            ...
            <el-tab-pane label="待发货" name="wait-receiving">
                ...
                <div class="tab-view-container">
                    ...
                    <personl-center-order-item v-for="item in orderList['wait-receiving']" :key="item.id" :order="item"></personl-center-order-item>
            ...
            <el-tab-pane name="refunding">
                ...
                <div class="tab-view-container">
                    ...
                    <personl-center-order-item v-for="item in orderList['refunding']" :key="item.id" :order="item" @redfunding:agree="agree" @redfunding:refuse="refuse"></personl-center-order-item>
            ...
            <el-tab-pane label="待发货" name="completed">
                ...
                <div class="tab-view-container">
                    ...
                    <personl-center-order-item v-for="item in orderList['completed']" :key="item.id" :order="item"></personl-center-order-item>
        ...
        <div v-show="showStatis" class="statis-box">
            <div class="statis-head">统计</div>
            <div class="data-box">
                <div class="data-title">订单统计</div>
                <div class="data-line clearfix">
                    <span class="text-left">今日成交订单</span>
                    <span class="text-right theme-font" v-text="statistics.order.today"></span>
                </div>
                <div class="data-line clearfix">
                    <span class="text-left">本月成交订单</span>
                    <span class="text-right theme-font" v-text="statistics.order.thisMonth"></span>
                </div>
                <div class="data-line clearfix">
                    <span class="text-left">累计成交订单</span>
                    <span class="text-right theme-font" v-text="statistics.order.total"></span>
                </div>
            </div>
            <div class="data-box">
                ...
                <div class="data-line clearfix">
                    ...
                    <span class="text-right theme-font">¥{{statistics.income.today}}</span>
                </div>
                <div class="data-line clearfix">
                    <span class="text-left">本月成交额</span>
                    <span class="text-right theme-font">¥{{statistics.income.thisMonth}}</span>
                </div>
                <div class="data-line clearfix">
                    <span class="text-left">累计成交额</span>
                    <span class="text-right theme-font">¥{{statistics.income.total}}</span>
                </div>
            </div>
        </div>
