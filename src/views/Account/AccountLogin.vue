                ...
                <div class="login-card">
                    ...
                    <div class="account-content">
                        ...
                        <div class="register-box">
                            <router-link class="theme-font" :to="{name:'register'}">免费注册</router-link>
                        </div>
                    </div>
  ...
  methods: {
    ...
    wxLogin() {
      ...
      let wxLoginUrl = constants.WX_AUTH_URI.replace(
        ...
        .replace(
          "{REDIRECT_URI}",
          encodeURIComponent(constants.WX_REDIRECT_URI)
        )
        .replace("{STATE}",state);
    ...
    qqLogin() {
      ...
      let qqLoginUrl = constants.QQ_AUTH_URI.replace(
        ...
        .replace("{REDIRECT_URI}", encodeURI(constants.QQ_REDIRECT_URI))
        .replace("{STATE}", state);
