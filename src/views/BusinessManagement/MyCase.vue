        ...
        <el-tabs class="order-tab" v-model="currTab" @tab-click="handleClick">
            <el-tab-pane label="全部订单" name="all">
                <div class="tab-view-container">
                    ...
                    <my-case-item v-for="item in orderList['all']" :key="item.id" :order="item" @nopay:pay="pay" @nopay:cancel="cancelOrder" @consgin="consgin" @confrim="confrim" @refunding="refunding"></my-case-item>
            ...
            <el-tab-pane name="nopay">
                ...
                <div class="tab-view-container">
                    ...
                    <my-case-item v-for="item in orderList['nopay']" :key="item.id" :order="item" @nopay:pay="pay" @nopay:cancel="cancelOrder"></my-case-item>
            ...
            <el-tab-pane name="wait-shipping">
                ...
                <div class="tab-view-container">
                    ...
                    <my-case-item v-for="item in orderList['wait-shipping']" :key="item.id" :order="item" @consgin="consgin" @refunding="refunding"></my-case-item>
            ...
            <el-tab-pane label="待发货" name="wait-receiving">
                ...
                <div class="tab-view-container">
                    ...
                    <my-case-item v-for="item in orderList['wait-receiving']" :key="item.id" :order="item" @confrim="confrim"></my-case-item>
            ...
            <el-tab-pane name="completed">
                ...
                <div class="tab-view-container">
                    ...
                    <my-case-item v-for="item in orderList['completed']" :key="item.id" :order="item" @refunding="refunding"></my-case-item>
            ...
            <el-tab-pane name="refunding">
                ...
                <div class="tab-view-container">
                    ...
                    <my-case-item v-for="item in orderList['refunding']" :key="item.id" :order="item"></my-case-item>
